...
if (n<400){
  ...
  plot(sim1, "network", at = 15, vertex.col = "age", legend = T, mode = "fruchtermanreingold")
  if (formationType == "residence") {
    plot(sim1, "network", at = 15, vertex.col = "residence", legend = T, mode = "kamadakawai")
  } else {
    plot(sim1, "network", at = 15, vertex.col = "housing", legend = T, mode = "fruchtermanreingold")
  }
...
```{r}
library(intergraph)
nwplot = get_network(sim1, at = 1)

nwplot = asIgraph(nwplot)

graph = igraph::graph(nwplot)
